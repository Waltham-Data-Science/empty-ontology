 ...
 * [empty.yml](empty.yml)
     * Determines how your purl.obolibrary.org/obo/empty/ redirects will be handled
     ...
     * Paste in the contents of [empty.yml](empty.yml)
 ...
 * [empty.md](empty.md)
     ...
     * Paste in the contents of [empty.md](empty.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
